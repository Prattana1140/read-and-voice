...
<style scoped>.settings-page{min-height:calc(100vh - 140px);display:grid;place-items:center;background:var(--bg);padding:28px 20px 40px}.settings-card{width:min(720px,100%);display:grid;gap:18px;border:1px solid var(--border);border-radius:22px;background:var(--surface);box-shadow:var(--shadow);padding:28px}.settings-head h1{margin:0;color:var(--text-strong);font-size:32px;font-weight:900}.settings-head p{margin:8px 0 0;color:var(--text-muted);line-height:1.7}.setting-row{display:grid;grid-template-columns:20px 1fr;gap:14px;align-items:start;border:1px solid var(--border);border-radius:14px;background:var(--surface-soft);padding:16px}.setting-row input{margin-top:4px}.setting-row strong{display:block;color:var(--text-strong)}.setting-row small{display:block;margin-top:4px;color:var(--text-muted);line-height:1.6}.actions{display:flex;justify-content:flex-end;gap:10px}button{min-height:44px;border:0;border-radius:12px;background:#10b981;color:#ffffff;cursor:pointer;font-weight:900;padding:0 16px}button.secondary{background:var(--surface-soft);color:var(--text-strong)}</style>
