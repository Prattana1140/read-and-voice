  ...
  <div class="admin-page-content">
    <header class="page-hero">
      <div>
        ...
        <span>
          ตรวจว่าหน้าแรก, E-Book, รายตอน, ขายดี, มาใหม่, โปรโมชั่น,
    ...
    <section class="banner-manager">
      <div class="banner-form">
        ...
        <p>
          อัปโหลดรูปภาพแบนเนอร์ Pinto VIP หรือวาง URL รูปภาพ
    ...
    <section class="next-steps">
      ...
      <div class="step-grid">
        ...
        <article>
          ...
          <p>ตอนนี้รายตอนยังใช้ข้อมูลร่วมกับ E-Book ควรเพิ่มโมเดลตอน/ซีรีส์จริง</p>
        </article>
      </div>
    </section>
...
const menuPages = computed<MenuPage[]>(() => [
  ...
  buildPage({
    ...
    tasks: [
      ...
      "ตอนนี้ route ยังชี้กลับไปหน้า E-Book จึงควรทำต่อเป็นหน้าแยก",
    ],
  ...
  buildPage({
    ...
    tasks: [
      ...
      "ตรวจป้าย Best Seller ให้แสดงเฉพาะเล่มที่เหมาะสม",
    ],
    manageTo: "/admin/books",
  ...
  buildPage({
    ...
    tasks: [
      ...
      "ตรวจป้าย Best Seller หรือ Award ให้ตรงกับเล่มจริง",
    ],
    manageTo: "/admin/books",
  ...
  buildPage({
    ...
    tasks: [
      ...
      "ควรเพิ่ม field recommended หรือ editor_pick ใน backend",
  ...
  buildPage({
    ...
    current: 3,
    tasks: [
      "มีแพ็กเกจ VIP 30, 90 และ 365 วัน",
      "ตรวจราคาและสิทธิประโยชน์ให้ตรงกับ backend",
