...
- Name: local-ui-smoke.spec.ts >> admin and superadmin pages render with seeded operational data
- Location: tests\e2e\local-ui-smoke.spec.ts:148:1
      ...
      - generic [ref=e40]:
        ...
        - generic [ref=e44]:
          ...
          - textbox "อีเมล" [ref=e46]:
            ...
            - text: admintest@readandvoice.com
          - generic [ref=e47]:
